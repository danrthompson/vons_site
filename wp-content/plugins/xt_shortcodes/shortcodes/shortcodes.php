...
function xt_wp_video_vimeo($atts) {
	...
	if (!empty($clip_id) && is_numeric($clip_id)){
		return "<div class='video-frame'><div class='video-fluid-wrapper' style='padding-top: 56.25%;'><iframe src='http://player.vimeo.com/video/$clip_id?&amp;byline=0&amp;portrait=0' frameborder='0'></iframe></div></div>";
	}
}
...
function xt_wp_video_youtube($atts, $content=null) {
	...
	if (!empty($clip_id)){
		return "<div class='video-frame'><div class='video-fluid-wrapper' style='padding-top: 56.25%;'><iframe src='http://www.youtube.com/embed/$clip_id' frameborder='0'></iframe></div></div>";
	}
}
...
function xt_wp_header($atts, $content = null, $code) {	
	...
	return '<'.$tag.' class="image-header"><span class="image-header-blank">'. $icon . $text . '</span></'.$tag.'>';
}
