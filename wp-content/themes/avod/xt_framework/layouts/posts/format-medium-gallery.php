	...
	<div class="side-post">
		<div class="flexslider thumbnail post-gallery">
			<ul class="slides">
					...
					?>
						<li>
							<a href="<?php echo $large[0]; ?>" rel="prettyPhoto[gallery<?php echo $galleryID; ?>]" title="<?php echo str_replace('"', '\'', $attachment->post_excerpt); ?>">
	...
	<div class="post-details<?php if( $attachments ) echo ' post-details-side'; ?>">
