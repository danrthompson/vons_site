...
function customizationOpts( &$options, $id, $name, $attrs = array( 'border' => false, 'font' => false, 'color_a' => false, 'color_a_hover' => false, 'bg' => false, 'bg_hover' => false, 'border_hover' => false ) ) {
...
function printOpts( $id, $attrs = array( 'border' => false, 'font' => false, 'color_a' => false, 'color_a_hover' => false, 'bg' => false, 'bg_hover' => false, 'border_hover' => false  ) ) {
...
function xt_printFont($field, $selector, $sufix = ' !important', $blockLH = '') {
	...
	if($field['face'] != '' && $field['size'] != '') :
		...
		$line_height = '';
		if(isset($field['line_height']) && $field['line_height'] != '')
			$line_height = '/'.$field['line_height'];

		if($blockLH != '')
			$line_height = '';
		
		echo 'font: '.$field['style'].' '.$field['size'].$line_height.' '.$field['face'].$sufix.';';
	elseif($field['size'] != '') :
		echo 'font-size: '.$field['size'].';';
	elseif($field['face'] != '') :
		echo 'font-family: '.$field['face'].';';
	endif;
	...
	if($field['face'] != '' && ( !isset($field['line_height']) || $field['line_height'] == '' ) && $field['style'] == '' && $field['size'] == '') :
		echo 'font-family: '.$field['face'].';';
	endif;
