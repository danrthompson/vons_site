<?php
	...
	========================*/
		...
		/***********************************/
		$options[] = array(
		'name' => __('Gallery Post', 'options_framework_theme'),
		'type' => 'subheading');

		$options[] = array(
		'name' => __('Navigation Background', 'options_framework_theme'),
		'desc' => __('Define the background color of gallery post navigation.', 'options_framework_theme'),
		'id' => 'blog_gallery_bg',
		'std' => '', 
		'type' => 'color' );

		$options[] = array(
		'name' => __('Navigation Bullet Normal', 'options_framework_theme'),
		'desc' => __('Define the background color of gallery post navigation bullet.', 'options_framework_theme'),
		'id' => 'blog_gallery_bullet',
		'std' => '', 
		'type' => 'color' );

		$options[] = array(
		'name' => __('Navigation Bullet Active/Hover', 'options_framework_theme'),
		'desc' => __('Define the background color of gallery post navigation bullet when active/hovered.', 'options_framework_theme'),
		'id' => 'blog_gallery_bullet_hover',
		'std' => '', 
		'type' => 'color' );