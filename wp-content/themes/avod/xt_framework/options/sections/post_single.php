<?php
	...
	========================*/
		...
		$options[] = array(
		'name' => __('Tags Section Border', 'options_framework_theme'),
		'desc' => __('Define the border color of tags section.', 'options_framework_theme'),
		'id' => 'post_tags_border',
		'std' => '', 
		'type' => 'color' );
		...
		$options[] = array(
		'name' => __('Comment Border', 'options_framework_theme'),
		'desc' => __('Define the border color of a single comment block.', 'options_framework_theme'),
		'id' => 'post_comments_border',
		'std' => '', 
		'type' => 'color' );

		$options[] = array(
		'name' => __('Comment Background', 'options_framework_theme'),
		'desc' => __('Define the background color of a single comment block.', 'options_framework_theme'),
		'id' => 'post_comments_bg',
		'std' => '', 
		'type' => 'color' );
		...
		$options[] = array(
		'name' => __('Comment Reply Border', 'options_framework_theme'),
		'desc' => __('Define the border color of a single comment reply block.', 'options_framework_theme'),
		'id' => 'post_comments_reply_border',
		'std' => '', 
		'type' => 'color' );
