<?php
	...
	========================*/
		...
		/***********************************/
		$options[] = array(
		'name' => __('General Style', 'options_framework_theme'),
		'type' => 'subheading');

		$options[] = array(
		'name' => __('Navigation Background', 'options_framework_theme'),
		'desc' => __('Define the background color of slider navigation.', 'options_framework_theme'),
		'id' => 'slider_nav_bg',
		'std' => '', 
		'type' => 'color' );
		...
		'desc' => __('Define the background color of slider navigation bullet.', 'options_framework_theme'),
		'id' => 'slider_nav_bullet',
		'std' => '', 
		'type' => 'color' );

		$options[] = array(
		'name' => __('Navigation Bullet Active/Hover', 'options_framework_theme'),
		'desc' => __('Define the background color of slider navigation bullet when active/hovered.', 'options_framework_theme'),
		'id' => 'slider_nav_bullet_hover',
		'std' => '', 
		'type' => 'color' );
