<?php
	...
	========================*/
		...
		$options[] = array(
			...
			'desc' => __('Check it turn off footer bg.', 'options_framework_theme'),
		...
		$options[] = array(
			...
			'desc' => __('Check it turn off footer wrapper drop shadow.', 'options_framework_theme'),
			'id' => 'footer_wrapper_shadow',
			'std' => '0',
			'type' => 'checkbox');

		/*
		$options[] = array(
		'name' => __('Footer Border', 'options_framework_theme'),
		'desc' => __('Select the border color to footer.', 'options_framework_theme'),
		'id' => 'footer_border',
		'std' => '',
		'type' => 'color' );
		*/
		...
		$options[] = array(
		'name' => __('Widget Border', 'options_framework_theme'),
		'desc' => __('Select the color of widget border.', 'options_framework_theme'),
		...
		'id' => 'footer_widget_framed_border',
		'std' => '',
		'type' => 'color' );
		...
		'id' => 'footer_widget_framed_tab_color',
		'std' => '',
		'type' => 'color' );
		...
		'id' => 'footer_widget_framed_tab_bg',
		'std' => '',
		'type' => 'color' );
		...
		'id' => 'footer_widget_framed_tab_color_hover',
		'std' => '',
		'type' => 'color' );
		...
		'id' => 'footer_widget_framed_tab_bg_hover',
		'std' => '',
		'type' => 'color' );
		...
		/***********************************/
		$options[] = array(
		'name' => __('Go to Top', 'options_framework_theme'),
		'type' => 'subheading');

		$options[] = array(
			'name' => __('Hide "Go to Top" area?', 'options_framework_theme'),
			'desc' => __('Check it to hide the area.', 'options_framework_theme'),
			'id' => 'footer_hide_gototop',
			'std' => '0',
			'type' => 'checkbox');

		$options[] = array( 'name' => '"Go to Top" Font',
		'desc' => 'Configure the fonts of "Go to Top" area text (size, font family, style, line height and color).<br /><strong>Font Family and Font Size are mandatory!</strong><br /><small>Note: almost fonts do not have all the font styles avaliable. Check the avaliable styles at <a href="http://www.google.com/fonts/" target="_blank">Google Webfonts</a>.</small>',
		'id' => 'footer_font_gototop',
		'std' => array( 'size' => '', 'face' => '', 'color' => '', 'style' => '', 'line_height' => ''),
		'type' => 'typography',
		'options' => array(
			'faces' => $typography_mixed_fonts )
		...
		$options[] = array(
			'name' => __('Use dark arrow?', 'options_framework_theme'),
			'desc' => __('Check it to use dark arrow instead white version.', 'options_framework_theme'),
			'id' => 'footer_dark_gototop',
			'std' => '0',
			'type' => 'checkbox');