...
function of_sanitize_page_selector( $input ) {
	global $allowedposttags;
	$output = wp_kses( $input, $allowedposttags);
	return $output;
}

add_filter( 'of_sanitize_page_selector', 'of_sanitize_page_selector' );
...
function of_recognized_font_styles() {
	$default = array(
		...
		'lighter'      => __('Thin', 'options_framework_theme'),
		'bolder'      => __('Bolder', 'options_framework_theme'),
		'900'      => __('Ultra Bold', 'options_framework_theme'),
		'100'      => __('Ultra Light', 'options_framework_theme')
		);
...
function of_recognized_font_heights() {
	$sizes = range( 9, 71 );
	$sizes = apply_filters( 'of_recognized_font_sizes', $sizes );
	$sizes = array_map( 'absint', $sizes );
	return $sizes;
