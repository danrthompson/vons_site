...
**********************/
	...
	function xt_project_custom_init()
	{
	  ...
	  $xt_portfolio_domain = 'xt-portfolio';

	  $labels = array(
		'name' => _x('Projects', 'post type general name', $xt_portfolio_domain),
		'singular_name' => _x('Project', 'post type singular name', $xt_portfolio_domain),
		'add_new' => _x('New Project', 'project', $xt_portfolio_domain),
		'add_new_item' => __('Add New Project', $xt_portfolio_domain),
		'edit_item' => __('Edit Project', $xt_portfolio_domain),
		'new_item' => __('New Project', $xt_portfolio_domain),
		'view_item' => __('View Project', $xt_portfolio_domain),
		'search_items' => __('Search Projects', $xt_portfolio_domain),
		'not_found' =>  __('No projects found', $xt_portfolio_domain),
		'not_found_in_trash' => __('No projects found in Trash', $xt_portfolio_domain),
		'parent_item_colon' => '',
		'menu_name' => __('Projects', $xt_portfolio_domain)
	 ...
	 // Register Post Type
	  ...
	  // Portfolio Filters
	  $labels = array(
		'name' => _x( 'Filters', 'taxonomy general name', $xt_portfolio_domain),
		'singular_name' => _x( 'Filter', 'taxonomy singular name', $xt_portfolio_domain ),
		'search_items' =>  __( 'Search Filters', $xt_portfolio_domain ),
		'all_items' => __( 'All Filters', $xt_portfolio_domain ),
		'parent_item' => __( 'Parent Filter', $xt_portfolio_domain ),
		'parent_item_colon' => __( 'Parent Filter:', $xt_portfolio_domain ),
		'edit_item' => __( 'Edit Filters', $xt_portfolio_domain ),
		'update_item' => __( 'Update Filter', $xt_portfolio_domain ),
		'add_new_item' => __( 'Add New Filter', $xt_portfolio_domain ),
		'new_item_name' => __( 'New Filter Name', $xt_portfolio_domain ),
	  );
	...
	function xt_project_updated_messages( $messages ) {
	  ...
	  $messages['project'] = array(
		...
		1 => sprintf( __('Project updated. <a href="%s">View project</a>', $xt_portfolio_domain), esc_url( get_permalink($post_ID) ) ),
		2 => __('Custom field updated.', $xt_portfolio_domain),
		3 => __('Custom field deleted.', $xt_portfolio_domain),
		4 => __('Project updated.', $xt_portfolio_domain),
		/* translators: %s: date and time of the revision */
		5 => isset($_GET['revision']) ? sprintf( __('Project restored to revision from %s', $xt_portfolio_domain), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false,
		6 => sprintf( __('Project published. <a href="%s">View project</a>', $xt_portfolio_domain), esc_url( get_permalink($post_ID) ) ),
		7 => __('Project saved.', $xt_portfolio_domain),
		8 => sprintf( __('Project submitted. <a target="_blank" href="%s">Preview project</a>', $xt_portfolio_domain), esc_url( add_query_arg( 'preview', 'true', get_permalink($post_ID) ) ) ),
		9 => sprintf( __('Project scheduled for: <strong>%1$s</strong>. <a target="_blank" href="%2$s">Preview project</a>', $xt_portfolio_domain),
		  // translators: Publish box date format, see http://php.net/date
		  date_i18n( __( 'M j, Y @ G:i' ), strtotime( $post->post_date ) ), esc_url( get_permalink($post_ID) ) ),
		10 => sprintf( __('Project draft updated. <a target="_blank" href="%s">Preview project</a>', $xt_portfolio_domain), esc_url( add_query_arg( 'preview', 'true', get_permalink($post_ID) ) ) ),
	  );
