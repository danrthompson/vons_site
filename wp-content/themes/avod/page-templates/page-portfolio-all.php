<?php
/**
 * Template Name: Portfolio Grid 3 Columns All Projects
 */
...
get_header(); ?>
	...
	<div id="main-wrapper" class="full-callout-titlein page-portfolio-grid">
					...
					<div class="content content-full">
						<div class="the-content">
								...
								<?php 
									...
									get_template_part('xt_framework/portfolio/portfolio', 'all'); 
								?>
